    ...
    <section className="py-24 relative">
        <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
                ...
                <div className="w-full flex-col justify-start items-start lg:gap-10 gap-8 flex">
                                        ...
                                        <img className="w-10 h-10 rounded-full object-cover" src="https://pagedone.io/asset/uploads/1710226776.png" alt="Emily Jones"/>
                                            <div className="w-full flex-col justify-center items-start gap-1 inline-flex">
                                                <div className="w-full justify-between items-center gap-2.5 inline-flex">
                                                    <h5 className="text-gray-900 text-base font-semibold leading-relaxed">Emily Jones</h5>
                                                    <h6 className="text-right text-gray-500 text-sm font-normal leading-snug">24 April, 12:20 PM</h6>
                                                </div>
                                                <h6 className="text-gray-500 text-sm font-medium leading-snug">Surgeon doctor at Banha University</h6>
                                            </div>
                                        </div>
                  ...
                  <div className="w-full justify-between items-center inline-flex">
                    ...
                    <div className="justify-start items-center gap-1 flex">
                        ...
                        <span className="text-gray-500 text-sm font-normal leading-snug">20k</span>
                    </div>
                    ...
                    {/* Comment logo */}
                     <div className="justify-start items-center gap-1.5 flex">
                        ...
                        <span className="text-gray-500 text-sm font-normal leading-snug">12</span>
                    </div>
                    ...
                    <div className="justify-start items-center gap-1.5 flex">
                        ...
                        <span className="text-gray-500 text-sm font-normal leading-snug">10</span>
                    </div>
            ...
            <div className="w-full flex justify-between relative">
                        <div className="w-full flex justify-between relative">
                            <input type="text"className="relative w-full h-14 focus:outline-none border-x border-gray-200 border-b rounded-b-lg shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] py-3 pr-5 pl-[50px] bg-gray-50 placeholder-gray-400 text-gray-900 text-lg font-normal leading-8"placeholder="Write comment reply..."/>
