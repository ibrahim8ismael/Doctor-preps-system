...
function Replay(){
    ...
    return(
            <div className="w-full lg:p-8 p-5 bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-600 flex-col justify-start items-start gap-2.5 flex">
                    ...
                    <p className="text-gray-800 dark:text-white text-sm font-normal leading-snug">Aliquam sed diam tellus purus nulla consequat fermentum pulvinar. Erat consequat cras eget sed sed rhoncus auctor. Vel est est turpis vehicula natoque hendrerit id a elementum. Pellentesque viverra nibh eget morbi lorem risus augue. Donec risus curabitur quis pulvinar gravida pellentesque. Purus cras consectetur nisl a lacus. Non adipiscing proin lorem at eu. Adipiscing urna arcu neque ut eu ultrices ac libero. Est consequat dictumst arcu convallis.</p>
                        ...
                        <div className="justify-start items-start gap-6 inline-flex">
                            ...
                            <div className="justify-center items-center gap-2 flex">
                                ...
                                <h5 className="text-black dark:text-gray-500 text-sm font-normal leading-snug">100 Likes</h5>
                            </div>
                            ...
                            <div className="justify-center items-center gap-2 flex">
                                    ...
                                    <h5 className="text-black dark:text-gray-500 text-sm font-normal leading-snug">Replay</h5>
                            </div>
                        </div>
                </div>
            </div>
